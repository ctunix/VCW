...
runtime\python.exe myinfer.py 0 "E:\codes\py39\VCW-beta\todo-songs\1111.wav" "E:\codes\py39\logs\mi-test\added_IVF677_Flat_nprobe_7.index" harvest "test.wav" "weights/mi-test.pth" 0.6 cuda:0 True<br>
...
## Q13:如何中断和继续训练
现阶段只能关闭WebUI控制台双击go-webui.bat重启程序。网页参数也要刷新重新填写；<br>
