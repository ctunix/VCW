...
Dans VCW, elle est utilisée comme ceci :
...
Comme le temps de calcul augmente proportionnellement au nombre de n_probes, veuillez consulter la précision et choisir de manière appropriée. Personnellement, je ne pense pas que VCW ait besoin de tant de précision, donc n_probe = 1 est bien.
