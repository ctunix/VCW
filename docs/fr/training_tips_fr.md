Instructions et conseils pour la formation VCW
======================================
...
VCW commence à former le modèle à partir de poids pré-entraînés plutôt que de zéro, il peut donc être formé avec un petit ensemble de données.
