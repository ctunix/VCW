...
- Treine o modelo de extração de pitch vocal de código aberto mais forte do momento, o RMVPE, e use-o para treinamento de VCW, inferência off-line/em tempo real, com suporte a PyTorch/Onnx/DirectML
...
Lista de tarefas：
- ~~Vocos-VCW (vocoder minúsculo): não é eficaz~~
...
- Adicionar "Perguntas e respostas frequentes" na página da guia (você também pode consultar o wiki do VCW no github)
